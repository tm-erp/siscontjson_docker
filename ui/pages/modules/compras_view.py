...
def show():
    ui.label("Módulo: Gestion Comercial Compras").classes(
        "text-2xl font-bold mb-1 text-gray-700"
    )
    ui.label("Bienvenido al módulo de Gestion Comercial Compras.").classes(
        "text-sm text-gray-500 mb-6"
    )
    ui.separator().classes("mb-6")

    ui.label("Aquí se gestionan todo lo relacionado con Compras.")
